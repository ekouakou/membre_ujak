!(function () {
    ...
    console.log(sessionStorage.getItem("data-bs-theme"))
    ...
    function e(e) {
        if (e == e) {
            switch (e["data-theme"]) {
                case "default":
                    T("data-theme", "default"), sessionStorage.setItem("data-theme", "default"), document.documentElement.setAttribute("data-theme", "default");
                    break;
                case "minimal":
                    T("data-theme", "minimal"), sessionStorage.setItem("data-theme", "minimal"), document.documentElement.setAttribute("data-theme", "minimal");
                    break;
                case "saas":
                    T("data-theme", "saas"), sessionStorage.setItem("data-theme", "saas"), document.documentElement.setAttribute("data-theme", "saas");
                    break;
                case "corporate":
                    T("data-theme", "corporate"), sessionStorage.setItem("data-theme", "corporate"), document.documentElement.setAttribute("data-theme", "corporate");
                    break;
                case "galaxy":
                    T("data-theme", "galaxy"), sessionStorage.setItem("data-theme", "galaxy"), document.documentElement.setAttribute("data-theme", "galaxy"), (document.getElementById("body-img").style.display = "block");
                    break;
                case "material":
                    T("data-theme", "material"), sessionStorage.setItem("data-theme", "material"), document.documentElement.setAttribute("data-theme", "material");
                    break;
                case "creative":
                    T("data-theme", "creative"), sessionStorage.setItem("data-theme", "creative"), document.documentElement.setAttribute("data-theme", "creative");
                    break;
                case "minimal":
                    T("data-theme", "minimal"), sessionStorage.setItem("data-theme", "minimal"), document.documentElement.setAttribute("data-theme", "minimal");
                    break;
                case "modern":
                    T("data-theme", "modern"), sessionStorage.setItem("data-theme", "modern"), document.documentElement.setAttribute("data-theme", "modern");
                    break;
                case "interactive":
                    T("data-theme", "interactive"), sessionStorage.setItem("data-theme", "interactive"), document.documentElement.setAttribute("data-theme", "interactive");
                    break;
                case "classic":
                    T("data-theme", "classic"), sessionStorage.setItem("data-theme", "classic"), document.documentElement.setAttribute("data-theme", "classic");
                    break;
                case "vintage":
                    T("data-theme", "vintage"), sessionStorage.setItem("data-theme", "vintage"), document.documentElement.setAttribute("data-theme", "vintage");
                    break;
                default:
                    T("data-theme", "default"), sessionStorage.setItem("data-theme", "default"), document.documentElement.setAttribute("data-theme", "default");
            }
            ...
            switch (e["data-theme-colors"]) {
                case "default":
                    T("data-theme-colors", "default"), sessionStorage.setItem("data-theme-colors", "default"), document.documentElement.setAttribute("data-theme-colors", "default");
                    break;
                case "green":
                    T("data-theme-colors", "green"), sessionStorage.setItem("data-theme-colors", "green"), document.documentElement.setAttribute("data-theme-colors", "green");
                    break;
                case "purple":
                    T("data-theme-colors", "purple"), sessionStorage.setItem("data-theme-colors", "purple"), document.documentElement.setAttribute("data-theme-colors", "purple");
                    break;
                case "blue":
                    T("data-theme-colors", "blue"), sessionStorage.setItem("data-theme-colors", "blue"), document.documentElement.setAttribute("data-theme-colors", "blue");
                    break;
                default:
                    T("data-theme-colors", "default"), sessionStorage.setItem("data-theme-colors", "default"), document.documentElement.setAttribute("data-theme-colors", "default");
            }
            switch (e["data-body-image"]) {
                ...
                default:
                    sessionStorage.getItem("data-body-image") && "img-1" == sessionStorage.getItem("data-body-image")
                        ...
                        : (sessionStorage.setItem("data-body-image", "none"), T("data-body-image", "none"), document.documentElement.setAttribute("data-body-image", "none"));
            }
        }
    }
    function p() {
            ...
            e == a.value ? (a.checked = !0) : (a.checked = !1),
                a.addEventListener("change", function () {
                    ...
                    "semibox" == document.documentElement.getAttribute("data-layout") &&
                        ...
                        ("data-bs-theme" != n && "data-theme" != n && "data-theme-colors" != n) || window.dispatchEvent(x),
                        "data-theme" == n &&
                            (document.documentElement.setAttribute("data-theme", a.value),
                            (document.getElementById("body-img").style.display = "galaxy" === a.value ? "block" : "none"),
                            "galaxy" === a.value
                                ? (document.documentElement.setAttribute("data-sidebar", "dark"), document.documentElement.setAttribute("data-bs-theme", "dark"))
                                : (document.documentElement.setAttribute("data-sidebar", sessionStorage.getItem("data-sidebar")), document.documentElement.setAttribute("data-bs-theme", sessionStorage.getItem("data-bs-theme")))),
    ...
    sessionStorage.getItem("defaultAttribute")
        ? (((h = {})["data-layout"] = sessionStorage.getItem("data-layout")),
          ...
          (h["data-layout-position"] = sessionStorage.getItem("data-layout-position")),
        ...
        : ((L = document.documentElement.attributes),
          ...
          Array.from(L).forEach(function (e) {
              var t;
              e && e.nodeName && "undefined" != e.nodeName && ((t = e.nodeName), (h[t] = e.nodeValue), sessionStorage.setItem(t, e.nodeValue));
          }),
        ...
        (I = document.getElementById("search-options")) &&
            (I.addEventListener("focus", function () {
                0 < I.value.length ? (v.classList.add("show"), f.classList.remove("d-none")) : (v.classList.remove("show"), f.classList.add("d-none"));
            }),
            ...
            document.body.addEventListener("click", function (e) {
                "search-options" !== e.target.getAttribute("id") && (v.classList.remove("show"), f.classList.add("d-none"));
            })),
            ...
            Array.from(document.querySelectorAll("#page-topbar .dropdown-menu-cart .remove-item-btn")).forEach(function (e) {
                e.addEventListener("click", function (e) {
                    B--,
                        ...
                        F(),
                        document.getElementById("empty-cart") && (document.getElementById("empty-cart").style.display = 0 == B ? "block" : "none"),
                        document.getElementById("checkout-elem") && (document.getElementById("checkout-elem").style.display = 0 == B ? "none" : "block");
                });
            }),
            Array.from(document.getElementsByClassName("cartitem-badge")).forEach(function (e) {
                e.innerHTML = B;
            ...
            a.addEventListener("click", function () {
                ...
                t["data-toast-text"] && (e.text = t["data-toast-text"].value.toString()),
                    ...
                    Toastify({
                        ...
                        duration: e.duration,
                        close: "close" == e.close,
                        style: "style" == e.style ? { background: "linear-gradient(to right, var(--vz-success), var(--vz-primary))" } : "",
                    }).showToast();
            });
        }),
